                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Type Cursuses</h4>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Polytechnic</a></li>
                                    <li class="breadcrumb-item active">Type Cursuses</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Type Cursuses</h4>
                                                ...
                                                <div class="modal fade bs-edit{{ $type->id }}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="mt-4" action="{{url('admin/type_cursus_edit', $type->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                ...
                                                <div class="modal fade bs-delete{{ $type->id }}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="mt-4" action="{{url('admin/type_cursus_delete', $type->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
            ...
            <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="mt-4" action="{{url('admin/type_cursus_post')}}" method="POST">
                            @csrf
                            <div class="modal-body">
