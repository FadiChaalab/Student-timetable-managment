                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Groupe Cursuses</h4>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Polytechnic</a></li>
                                    <li class="breadcrumb-item active">Groupe Cursuses</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Groupe Cursuses</h4>
                                    <div class="table-responsive">
                                        <table class="table table-hover table-centered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$groupe_cursus->id}}</td>
                                                    <td>{{$groupe_cursus->libelle}}</td>
                                                    <td>{{$groupe_cursus->cursus->libelle}}</td>
                                                    <td>{{$groupe_cursus->groupe->libelle}}</td>
                                                    <td>
                                                        <button type="button"
                                                            class="btn btn-primary waves-effect waves-light"
                                                            data-toggle="modal"
                                                            data-target=".bs-edit{{ $groupe_cursus->id }}">Edit</button>
                                                        <button type="button"
                                                            class="btn btn-danger waves-effect waves-light"
                                                            data-toggle="modal"
                                                            data-target=".bs-delete{{ $groupe_cursus->id }}">Delete</button>
                                                    </td>
                                                </tr>

                                                <div class="modal fade bs-edit{{ $groupe_cursus->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="mt-4"
                                                                action="{{url('admin/groupe_cursus_edit', $groupe_cursus->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2"
                                                                            ...
                                                                            <option value="{{ $cursus->id }}" {{
                                                                                $groupe_cursus->id_cursus == $cursus->id
                                                                                ? 'selected'
                                                                                : ''}}>{{
                                                ...
                                                <div class="modal fade bs-delete{{ $groupe_cursus->id }}" tabindex="-1"
                                                    role="dialog" aria-labelledby="mySmallModalLabel"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="mt-4"
                                                                action="{{url('admin/groupe_cursus_delete', $groupe_cursus->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
            ...
            <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="mt-4" action="{{url('admin/groupe_cursus_post')}}" method="POST">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">groupe</label>
                                    <select class="form-control select2" name="id_groupe">
                                        <option>Select</option>
                                        @if (count($groupes) > 0)
                                        @foreach ($groupes as $groupe)
                                        <option value="{{ $groupe->id }}">{{
