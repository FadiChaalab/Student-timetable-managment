                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('admin/student/add_post')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-4"
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="cin"
                                                        placeholder="Enter cin" name="cin" value="{{old('cin')}}">
                                                </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="tel"
                                                        placeholder="Enter telephone" name="tel" value="{{old('tel')}}">
                                                </div>
                                                <div class="form-group">
