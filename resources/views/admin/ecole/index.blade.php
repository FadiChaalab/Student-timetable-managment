                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Ecoles</h4>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Ecoles</h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                            class="btn btn-primary waves-effect waves-light"
                                                            data-toggle="modal" data-target=".bs-edit{{ $ecole->id }}">Edit</button>
                                                        <button type="button"
                                                            class="btn btn-danger waves-effect waves-light"
                                                            data-toggle="modal" data-target=".bs-delete{{ $ecole->id }}">Delete</button>
                                                    </td>
                                                </tr>

                                                <div class="modal fade bs-edit{{ $ecole->id }}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="mt-4" action="{{url('admin/ecole_edit', $ecole->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                ...
                                                <div class="modal fade bs-delete{{ $ecole->id }}" tabindex="-1" role="dialog"
                                                    aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form class="mt-4" action="{{url('admin/ecole_delete', $ecole->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
            ...
            <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="mt-4" action="{{url('admin/ecole_post')}}" method="POST">
                            @csrf
                            <div class="modal-body">
