                        ...
                        <div class="col-12">
                            <div class="email-leftbar card">
                                ...
                                <div class="mail-list mt-4">
                                    ...
                                    <a href="{{url('admin/contact/impotant')}}">Important</a>
                                    <a href="#">Draft</a>
                                    <a href="{{url('admin/contact/sent')}}">Sent Mail</a>
                                    <a href="{{url('admin/contact/trash')}}"
                                ...
                                <div class="card">
                                    <div class="btn-toolbar p-3" role="toolbar">
                                        ...
                                        <div class="btn-group ml-1 mo-mb-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <form action="{{url('admin/contact/unread_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button class="dropdown-item" type="submit">Mark as Unread</button>
                                                </form>
                                                <form action="{{url('admin/contact/important_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button class="dropdown-item" type="submit">Mark as Important</button>
                                                </form>
                                                <a class="dropdown-item" href="#">Add to Tasks</a>
                                                <form action="{{url('admin/contact/star_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
            ...
            <div class="modal fade bs-trash{{ $contact->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="mt-4" action="{{url('admin/contact/trash_post', $contact->id)}}" method="POST">
                            @csrf
                            @method('PUT')
