                                ...
                                <div class="card">
                                    <div class="btn-toolbar p-3" role="toolbar">
                                        ...
                                        <div class="btn-group ml-1 mo-mb-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <form action="{{url('teacher/contact/unread_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button class="dropdown-item" type="submit">Mark as Unread</button>
                                                </form>
                                                <form action="{{url('teacher/contact/important_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button class="dropdown-item" type="submit">Mark as Important</button>
                                                </form>
                                                <a class="dropdown-item" href="#">Add to Tasks</a>
                                                <form action="{{url('teacher/contact/star_post', $contact->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
            ...
            <div class="modal fade bs-trash{{ $contact->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="mt-4" action="{{url('teacher/contact/trash_post', $contact->id)}}" method="POST">
                            @csrf
                            @method('PUT')
