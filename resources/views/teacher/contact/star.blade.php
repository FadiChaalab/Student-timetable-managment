                            ...
                            <div class="col-12">
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mail-list mt-4">
                                        ...
                                        <a href="{{url('teacher/contact/star')}}" class="active">Starred <span class="ml-1">
                                                @if(count($contacts) > 0)
                                                    ({{count($contacts)}})
                                                @endif
                                            </span></a>
                                                ...
                                                @foreach($contacts as $contact)
                                                    <li class="{{ $contact->read == 0 ? 'unread' : ''}}">
                                                        <div class="col-mail col-mail-1">
                                                            ...
                                                            <a href="{{url('teacher/contact/read', $contact->id)}}" class="title">{{$contact->id_sender == Auth::user()->id ? 'me' : $contact->sender->firstname}}, {{$contact->id_reciever == Auth::user()->id ? 'me' : $contact->reciever->firstname}}</a><span class="star-toggle fas fa-star"></span>
                                                        </div>
